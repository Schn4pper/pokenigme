...
export default class ConfigurationPanel {
	...
	public afficher(): void {
		...
		let titre = i18n[config.langue].configurationPanel.configuration;
		...
		contenu.appendChild(
			this.genererConfigItem(
				"langue",
				i18n[config.langue].configurationPanel.langue,
				[
					{ value: Langue.FR.toString(), label: i18n[config.langue].configurationPanel.francais },
					{ value: Langue.DE.toString(), label: i18n[config.langue].configurationPanel.allemand },
					{ value: Langue.EN.toString(), label: i18n[config.langue].configurationPanel.anglais },
				],
				(config.langue ?? Configuration.Default.langue).toString(),
				(event: Event) => {
		...
		contenu.appendChild(
			this.genererConfigItem(
				"volume",
				i18n[config.langue].configurationPanel.volume,
				[
					{ value: VolumeSon.Faible.toString(), label: i18n[config.langue].configurationPanel.volume_faible },
					{ value: VolumeSon.Normal.toString(), label: i18n[config.langue].configurationPanel.volume_normal },
					{ value: VolumeSon.Fort.toString(), label: i18n[config.langue].configurationPanel.volume_fort },
				],
		...
		contenu.appendChild(
			this.genererConfigItem(
				"disposition-clavier",
				i18n[config.langue].configurationPanel.clavier,
				[
		...
		contenu.appendChild(
			this.genererConfigItem(
				"police-ecriture",
				i18n[config.langue].configurationPanel.police,
				[
					{ value: Police.Humaine.toString(), label: i18n[config.langue].configurationPanel.police_humaine },
					{ value: Police.Zarbi.toString(), label: i18n[config.langue].configurationPanel.police_zarbi }
				],
		...
		contenu.appendChild(
			this.genererConfigItem(
				"theme",
				i18n[config.langue].configurationPanel.theme,
				[
					{ value: Theme.Sombre.toString(), label: i18n[config.langue].configurationPanel.theme_sombre },
					{ value: Theme.Clair.toString(), label: i18n[config.langue].configurationPanel.theme_clair },
					{ value: Theme.SombreAccessible.toString(), label: i18n[config.langue].configurationPanel.theme_sombre_accessible },
					{ value: Theme.ClairAccessible.toString(), label: i18n[config.langue].configurationPanel.theme_clair_accessible },
				],
		...
		contenu.appendChild(
			this.genererConfigItem(
				"afficher-temps",
				i18n[config.langue].configurationPanel.temps,
				[
					{ value: false.toString(), label: i18n[config.langue].configurationPanel.non },
					{ value: true.toString(), label: i18n[config.langue].configurationPanel.oui },
				],
		...
		contenu.appendChild(
			this.genererConfigItem(
				"haptique",
				i18n[config.langue].configurationPanel.retour_haptique,
				[
					{ value: false.toString(), label: i18n[config.langue].configurationPanel.non },
					{ value: true.toString(), label: i18n[config.langue].configurationPanel.oui },
				],
		...
		label.innerText = i18n[config.langue].configurationPanel.generations;
		...
		contenu.appendChild(
			this.genererConfigItem(
				...
				i18n[config.langue].configurationPanel.propositions,
				[
					{ value: "1", label: "1" },
					{ value: "2", label: "2" },
					{ value: "3", label: "3" },
		...
		contenu.appendChild(
			this.genererConfigSaisieNumerique(
				...
				i18n[config.langue].configurationPanel.a_trouver,
		...
		contenu.appendChild(
			this.genererConfigSaisieNumerique(
				...
				i18n[config.langue].configurationPanel.temps_imparti,
	...
	private genererZoneExportSauvegarde(): HTMLElement {
		...
		titreSection.innerText = i18n[config.langue].configurationPanel.exporter_stats;
		div.appendChild(titreSection);

		const explication = document.createElement("p");
		explication.innerText = i18n[config.langue].configurationPanel.exporter_stats_etapes;
		...
		etape1Texte.innerText = i18n[config.langue].configurationPanel.exporter_stats_lien;
		...
		CopieHelper.attacheBoutonCopieLien(etape1Bouton, lien, i18n[config.langue].configurationPanel.lien_copie);
		etape1.appendChild(etape1Bouton);

		listeEtape.appendChild(etape1);

		const etape2 = document.createElement("li");
		etape2.innerText = i18n[config.langue].configurationPanel.envoi_lien;
		listeEtape.appendChild(etape2);

		const etape3 = document.createElement("li");
		etape3.innerText = i18n[config.langue].configurationPanel.ouvrir_lien;
